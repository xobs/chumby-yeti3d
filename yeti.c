...
**       the video buffer.
*/
void viewport_to_video(rgb555_t* video, int pitch, viewport_t* vp, int rmask, int gmask, int bmask)
{
	int i, y;
...
*/
void yeti_init(yeti_t* yeti, framebuffer_t* front, framebuffer_t* back, texture_t* textures, palette_t palette,
               lua_t lua)
{
  int i;
